...
var notification = {
    timeVisible: 16000,
    path: jive.app.url({path:"/__services/v2/rest/notification/"}),
    userid: '',
    xt: 0,
...
;
if(typeof bv=="undefined"){var bv={}}if(typeof bv.visual=="undefined"){bv.visual={}}bv.visual.renderStatusLevel=function(A,C){var B=C||new soy.StringBuilder();B.append('<span class="j-status-levels">',(A.user.metadata)?'<img src="'+soy.$$escapeHtmlAttribute(soy.$$filterNormalizeUri(jive.soy.func.normalizeUrl(window._jive_base_url,A.user.metadata["userLevel"].imageUrl)))+'" alt="'+soy.$$escapeHtmlAttribute(A.user.metadata["userLevel"].name)+'" title="'+soy.$$escapeHtmlAttribute(A.user.metadata["userLevel"].name)+'"><span class="level-points">'+soy.$$escapeHtml(A.user.metadata["userLevel"].name)+" <span>("+soy.$$escapeHtml(A.user.metadata["userLevel"].points)+" "+soy.$$escapeHtml(jive.i18n.i18nText(jive.i18n.getMsg("jivemacro.points.label"),[]))+")</span> </span>":"","</span>");return C?"":B.toString()};bv.visual.renderMyRewards=function(C,G){var D=G||new soy.StringBuilder();if(C.user.metadata.isBetaUser){D.append('<div class="status-row reward-tile"><h3>',soy.$$escapeHtml(jive.i18n.i18nText(jive.i18n.getMsg("gamification.rewards"),[])),"</h3><ul>");if(typeof (C.user.metadata.rewards)=="undefined"){D.append('<li class="listTypeNone"><a href="',soy.$$escapeHtmlAttribute(soy.$$filterNormalizeUri(jive.soy.func.normalizeUrl(window._jive_base_url,""))),'">',soy.$$escapeHtml(jive.i18n.i18nText(jive.i18n.getMsg("gamification.learn.more.rewards"),[])),"...</a></li>")}else{if(C.user.metadata.rewards){var B=C.user.metadata.rewards;var E=B.length;for(var F=0;F<E;F++){var A=B[F];switch(F){case 0:case 1:case 2:case 3:case 4:case 5:case 6:case 7:case 8:D.append('<li class="listTypeNone popuplistspace"><a href="javascript:void(0)" class="target-mission" role="button" aria-label="',soy.$$escapeHtmlAttribute(A.name),'" aria-expanded="false" data-user="',soy.$$escapeHtmlAttribute(C.user.id),'"  data-type="reward" data-name="',soy.$$escapeHtmlAttribute(C.user.username),'" data-mid="',soy.$$escapeHtmlAttribute(A.id),'" data-parent="false"><div class="status-image ',soy.$$escapeHtmlAttribute(A.complete),'"><img src="',soy.$$escapeHtmlAttribute(soy.$$filterNormalizeUri(jive.soy.func.resourceUrl(window._jive_base_url,"/6.0.3.0/","",A.imageUrl))),'" class="svg" title="',soy.$$escapeHtmlAttribute(A.name),'" alt="',soy.$$escapeHtmlAttribute(A.name),'" /></div></a></li>');break;case 9:D.append('<li class="listTypeliNone"><a href="',soy.$$escapeHtmlAttribute(soy.$$filterNormalizeUri(jive.soy.func.normalizeUrl(window._jive_base_url,"/people/"+C.user.username))),'" role="button" aria-label="',soy.$$escapeHtmlAttribute(jive.i18n.i18nText(jive.i18n.getMsg("gamification.more.rewards"),[])),'" class="view-more">',soy.$$escapeHtml(jive.i18n.i18nText(jive.i18n.getMsg("gamification.more.rewards"),[])),"...</a></li>");break;default:}if(F==E-1){jive.shared.soy.resourceInlineJs({code:"window.convertSVG('.reward-tile'); $(\"#j-satNav-menu ul li a\").each(function (i) { $(this).attr('tabindex', i+1 ); });"},D)}}}}D.append("</ul></div>")}return G?"":D.toString()};bv.visual.renderMyExpertise=function(A,G){var B=G||new soy.StringBuilder();if(A.user.metadata.isBetaUser){B.append('<div class="status-row expertise"><h3>',soy.$$escapeHtml(jive.i18n.i18nText(jive.i18n.getMsg("gamification.expertise"),[])),"</h3><ul>");if(A.user.metadata.expertise){if(A.user.metadata.expertise==0){B.append('<li class="listTypeliNone"><a href="',soy.$$escapeHtmlAttribute(soy.$$filterNormalizeUri(jive.soy.func.normalizeUrl(window._jive_base_url,"/docs/DOC-9254"))),'">',soy.$$escapeHtml(jive.i18n.i18nText(jive.i18n.getMsg("gamification.learn.more.expertise"),[])),"...</a></li>")}else{var F=A.user.metadata.expertise;var C=F.length;for(var D=0;D<C;D++){var E=F[D];switch(D){case 0:case 1:case 2:case 3:B.append('<li class="status-tile expertise-tile"><a href="javascript:void(0)" class="target-mission" role="button" aria-label="',soy.$$escapeHtmlAttribute(E.parentName),'" data-user="',soy.$$escapeHtmlAttribute(A.user.id),'" data-type="expertise" data-name="',soy.$$escapeHtmlAttribute(A.user.username),'" data-mid="',soy.$$escapeHtmlAttribute(E.id),'" data-parent="false"><div class="status-image"><img src="',soy.$$escapeHtmlAttribute(soy.$$filterNormalizeUri(jive.soy.func.normalizeUrl(window._jive_base_url,E.imageUrl))),'" class="svg" title="',soy.$$escapeHtmlAttribute(E.name),'" alt="',soy.$$escapeHtmlAttribute(E.name),'" /></div><span class="status-label">',soy.$$escapeHtml(E.parentName),'</span><span class="status-level sml"><span class="dashes level',(E.complete)?soy.$$escapeHtmlAttribute(E.absoluteOrder):soy.$$escapeHtmlAttribute(E.absoluteOrder-1),'"></span><span class="progress-dashes"></span></span></a></li>');break;case 4:B.append('<li class="listTypeliNone"><a href="',soy.$$escapeHtmlAttribute(soy.$$filterNormalizeUri(jive.soy.func.normalizeUrl(window._jive_base_url,"/people/"+A.user.username))),'" class="view-more">',soy.$$escapeHtml(jive.i18n.i18nText(jive.i18n.getMsg("gamification.more.expertise"),[])),"...</a></li>");break;default:}}}}B.append("</ul></div>")}return G?"":B.toString()};bv.visual.renderStatusLevelPeople=function(A,C){var B=C||new soy.StringBuilder();B.append('\t<span class="j-status-levels"><img src="',soy.$$escapeHtmlAttribute(soy.$$filterNormalizeUri(jive.soy.func.normalizeUrl(window._jive_base_url,A.metadata["userLevel"].imageUrl))),'" alt="',soy.$$escapeHtmlAttribute(A.metadata["userLevel"].name),'" title="',soy.$$escapeHtmlAttribute(A.metadata["userLevel"].name),'"><span class="level-points">',soy.$$escapeHtml(A.metadata["userLevel"].name),"</span></span>");return C?"":B.toString()}
;
