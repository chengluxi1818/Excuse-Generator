$j(function ($) {
    ...
    $toolTipIcon = '<span class="tooltipDiv"><img id="tooltip-icon" src="'+jive.app.url({path:'/themes/apple/img/asc_rr_tooltip_icon_1x.png'})+'"/></span>'
    ...
    $(document).on('click','.js-leader', function(){
        ...
        $.ajax({
                  type: 'GET',
                  url: jive.app.url({path:'/render-widget!execute.jspa'}),
                  data: data,
